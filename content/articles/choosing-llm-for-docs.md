...
Требования к мощности модели определяются самой сложной частью пайплайна. В большинстве случаев стоит выбрать самую мощную модель из доступных, и вам не придётся переключаться между инструментами. При этом стоит иметь виду, что типичные задачи, связанные с документацией, менее требовательны к ресурсам, чем задачи разработчиков. Из этого следует, что технические писатели могут использовать те модели и укладывать в такие лимиты, которые сделали бы работу программистов невозможной.
...
В качестве примера того, почему важна именно самая сложная часть пайплайна, возьмём задачу вида «научиться генерировать документацию из записей созвонов». Она может декомпозироваться следующим образом:
