...
В этой статье я опишу набор навыков для профессионала в нашей отрасли. Эту статью можно рассматривать как чеклист, но ни в коем случае не как карту развития, матрицу компетенций или исчерпывающее руководство по профессии.
...
> Мне не попадались хорошие переводы этих терминов. Hard skills — это технические навыки, особенно когда речь идет об инженерах и разработчиках. Это то, что нужно каждому специалисту для выполнения своей работы.
>
> Soft skills я бы перевел как социальные навыки. Эти навыки характеризуют работу в команде и социальное взаимодействие. Они позволяют выполнять работу эффективнее.
>
...
Чтобы писать о технологии, нужно понимать, какие задачи стоят перед пользователями, что они хотят сделать с помощью описываемого продукта. Далеко не для всех перечисленных ниже пунктов нужно иметь практический опыт, но по большей части хватит уверенного владения теорией.
...
Я считаю инструменты наименее важной частью компетенций технического писателя. При этом они легче всего поддаются изучению и их любят указывать в вакансиях. Технического писателя нанимают для донесения знаний до аудитории. Как именно это произойдет — как минимум вторично, пусть и с некоторыми оговорками.

- **Docs as Code**:
  - Системы контроля версий и связанные платформы — Git, GitHub, GitLab;
  - [Генераторы статических сайтов](@/articles/ssg-comparison.md) (SSG) — Docusaurus, MkDocs, Sphinx и другие;
...
- **Работа с ИИ-инструментами**.<br/>
  ...
  Выбирайте модель под свои задачи, не забывая о безопасности.
...
Soft skills — это личностные качества и поведенческие навыки. Я считаю, что они развиваются с опытом. Они выводятся из нескольких простых принципов. Например, общаться с коллегами уважительно, работать над обратной связью, брать на себя ответственность и обеспечивать прозрачность.
...
Часто технический писатель — это последний человек в команде, который может посмотреть на продукт «глазами пользователя» и поработать с ним перед релизом.
...
Чтобы понимать, насколько хорошо документация решает задачи пользователей, имеет смысл посмотреть на реальные данные.
...
- **Автоматизация проверок**:
  - Орфография — с помощью [Cspell](https://habr.com/ru/articles/902236/) или [Vale](https://vale.sh/);
